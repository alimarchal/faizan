            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item" >
                                <a class="nav-link" href="{{ route('login') }}" style="color: black"><b>{{ __('Login') }}</b></a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item" style="padding-left: 30px">
                                    <a class="nav-link btn btn-info"  href="{{ route('register') }}" style="color: black"><b>{{ __('Register') }}</b></a>
                                </li>
                            @endif
                        @else
