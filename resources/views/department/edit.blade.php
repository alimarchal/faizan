                                ...
                                <form action="{{ url('departments/'.$department->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6    ">
                                            ...
                                            <input type="text" name="dep_name" class="form-control" value="{{$department->dep_name}}"
                                                   class="col-md-6">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="short_name" class="form-control" value="{{$department->short_name}}"
                                                   placeholder="e.g; CD for Civil Defence"
                                                   class="col-md-6">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description" class="form-control tinymce" placeholder="e.g; CD for Civil Defence"
                                                      class="col-md-3">{{$department->description}}</textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <a href="{{url('uploads/department/'. $department->logo)}}" target="_blank"><img
                                                        src="{{url('uploads/department/'. $department->logo)}}"></a>
