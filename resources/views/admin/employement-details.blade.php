            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="/employement-details/{{ $employee_id }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @if (count($employee->EmployementDetails) > 0)
                                        @foreach ($employee->EmployementDetails as $ed)
                                            <div class="myqual">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <a href="{{ url('employement-details/' . $ed->employee_id . '/' . $ed->id) }}" class="btn btn-danger float-right">Edit</a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="exampleInputEmail1" class="col-md-6">
                                                            Designation:</label> {{ $ed->designation }}
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="exampleInputEmail1" class="col-md-6">
                                                            Bps:</label>{{ $ed->bps }}
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="exampleInputEmail1" class="col-md-6"> Time Scale
                                                            Date:</label>{{ \Carbon\Carbon::parse($ed->time_scale_date)->format('d-m-Y') }}

                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="exampleInputEmail1" class="col-md-6"> Appointment
                                                            Date:</label>{{ \Carbon\Carbon::parse($ed->appointment_date)->format('d-m-Y') }}
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="exampleInputEmail1" class="col-md-6"> Join
                                                            Date:</label>{{ \Carbon\Carbon::parse($ed->join_date)->format('d-m-Y') }}
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    @if ($ed->image)
                                                        <div class="col-md-4">
                                                            <label for="exampleInputEmail1" class="col-md-6">
                                                                Image:</label>
                                                            <a href="{{ asset('uploads/employee/' . $ed->image) }}" target="_blank">Show Appointment
                                                            </a>
                                                        </div>
                                                    @endif
                                    ...
                                    @else
                                        <div class="myqual">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="file" name="filelogo[]" for="exampleInputEmail1" class="form-control-file">
                                                ...
                                                <div class="col-md-6 ">
                                                    <label for="exampleInputEmail1" class="col-md-6">
                                                        Designation*</label>
                                                    <input type="text" name="designation[]" value="{{ old('designation') }}" class="form-control" required minlength="3">
                                                </div>

                                                <div class="col-md-6 ">
                                                    <label for="exampleInputEmail1" class="col-md-6"> BPS</label>
                                                    <input type="text" name="bps[]" value="{{ old('bps') }}" class="form-control ">
                                                </div>
                                                ...
                                                <div class="col-md-6 ">
                                                    <label for="exampleInputEmail1" class="col-md-6"> Time Scale
                                                        Date*</label>
                                                    <input type="date" name="time_scale_date[]" value="{{ old('time_scale_date') }}" class="form-control ">
                                                </div>
                                                <div class="col-md-6 ">
                                                    <label for="exampleInputEmail1" class="col-md-6"> Appointment
                                                        Date</label>
                                                ...
                                                <div class="col-md-6 ">
                                                    <label for="exampleInputEmail1" class="col-md-6"> Gross
                                                        Salary</label>
                                                    <input type="number" name="gross_salary[]" value="{{ old('gross_salary') }}" class="form-control ">
                                                </div>
                                                <hr width="100%" style="margin-top: 3rem">
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3" align="right">
                                            <a href="/qualifications/{{ $employee_id }}/edit" type="" class="btn btn-danger"> Skip </a>
                                        </div>
                                    </div>
                                ...
                                <div class="newqual" style="display: none">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 ">
                                            ...
                                            <input type="text" name="designation[]" value="" class="form-control " minlength="3" required>
                                        </div>
                                        ...
                                        <div class="col-md-6 ">
                                            <label for="exampleInputEmail1" class="col-md-6"> Appointment Date</label>
