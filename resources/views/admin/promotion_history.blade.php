                                    ...
                                    @if(count($employee->promotion)>0)
                                        ...
                                        <div class="myqual">
                                            ...
                                            <div class="row" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="exampleInputEmail1" class="col-md-6"> Designation:</label> {{$prom->designation}}
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="exampleInputEmail1" class="col-md-6"> Date of Promotion:</label>{{$prom->date}}
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="exampleInputEmail1" class="col-md-6"> Date of Selection:</label> {{$prom->selection_date}}
                                                    </div>
                                                    <div class="col-md-6">
